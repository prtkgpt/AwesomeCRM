  ...
  try {
    ...
    return NextResponse.json({
      ...
      data: {
        ...
        suppliesCost: company.suppliesCost || 0,
        gasReimbursementRate: company.gasReimbursementRate || 0,
        adminSalary: company.adminSalary || 0,
...
export async function PUT(request: NextRequest) {
  try {
    ...
    const expenses = {
      ...
      suppliesCost: parseFloat(body.suppliesCost) || 0,
      gasReimbursementRate: parseFloat(body.gasReimbursementRate) || 0,
      adminSalary: parseFloat(body.adminSalary) || 0,
